...
async function eliminarEvento(id) {
    ...
    console.warn(`Eliminando evento con ID: ${id}`);
...
async function eliminarLugar(id) {
    // Reemplazamos confirm()
    console.warn(`Eliminando lugar cultural con ID: ${id}`);
...
async function mostrarEventoMasFavoritoDashboard() {
    ...
    try {
        ...
        `;
         ...
         const canvasTop = document.getElementById("graficoTopEventos"); 
