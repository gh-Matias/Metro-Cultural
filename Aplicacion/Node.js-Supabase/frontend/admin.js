...
async function eliminarUsuario(id) {
    // Reemplazamos confirm() por lógica de eliminación directa (SE REQUIERE MODAL DE CONFIRMACIÓN EN HTML)
    console.warn(`[CONFIRMACIÓN MANUAL REQUERIDA] Eliminando usuario con ID: ${id}`); 
...
// Hacemos las funciones de Usuario accesibles globalmente
